...
* eth2 : Rosenberger H-MTD connector that supports 100 and 1000BASE-T1
* eth3 : Rosenberger H-MTD connector that supports 100 and 1000BASE-T1

For Automotive Ethernet configuration, see the [setup guide](automotive_ethernet_setup_guide.md).
